            ...
            <?php if(have_posts()): while(have_posts()): the_post();?>
              ...
              <div class="blog-list blog-list1">
                ...
                <div class="blog-text">
                  ...
                  <p><?php the_excerpt();?></p>
                  <a class="button-link" href="<?php the_permalink();?>"><?php esc_html_e('Read More', 'fruit_shop');?></a>
                </div>
              </div>
              <?php endwhile;
                ...
                <div class="pagination-list">
                  ...
                  <?php 
                      the_posts_pagination(array(
                          'prev_text'=> esc_html__('Prev', 'fruit_shop'),
                          'next_text'=> esc_html__('Next', 'fruit_shop'),
                      )); 
                  ?>
                  </ul>
                </div>
